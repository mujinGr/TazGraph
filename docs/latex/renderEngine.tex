...
\hypertarget{renderEngine_autotoc_md2}{}\doxysubsubsubsection{\texorpdfstring{Graph Rendering Pipeline}{Graph Rendering Pipeline}}\label{renderEngine_autotoc_md2}
All rendering logic is handled in {\ttfamily Graph\+::draw()}.\hypertarget{renderEngine_autotoc_md3}{}\doxyparagraph{\texorpdfstring{1. Shader Setup}{1. Shader Setup}}\label{renderEngine_autotoc_md3}
...
\end{DoxyCode}
\hypertarget{renderEngine_autotoc_md4}{}\doxyparagraph{\texorpdfstring{2. Render Pass Initialization}{2. Render Pass Initialization}}\label{renderEngine_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{renderEngine_autotoc_md5}{}\doxyparagraph{\texorpdfstring{3. Render Batching (\+Multithreaded)}{3. Render Batching (Multithreaded)}}\label{renderEngine_autotoc_md5}
...
\end{DoxyCode}
\hypertarget{renderEngine_autotoc_md6}{}\doxyparagraph{\texorpdfstring{4. Instance Rendering}{4. Instance Rendering}}\label{renderEngine_autotoc_md6}
...
{\ttfamily Not all \doxylink{classEntity}{Entity} Components can draw with all renderers (e.\+g. Sprite \doxylink{classComponent}{Component} is used to specifically draw for \doxylink{classPlaneModelRenderer}{Plane\+Model\+Renderer}). The draw function in the component indicates the renderers used\+: {\ttfamily void draw(size\+\_\+t v\+\_\+index,}{\ttfamily \doxylink{classPlaneModelRenderer}{Plane\+Model\+Renderer}}{\ttfamily \& batch, \doxylink{classTazGraphEngine_1_1Window}{Taz\+Graph\+Engine\+::\+Window}\& window) \{ ... \} }}\hypertarget{renderEngine_autotoc_md7}{}\doxysubsubsubsection{\texorpdfstring{Custom Renderers}{Custom Renderers}}\label{renderEngine_autotoc_md7}
