...
void OrientationBox::OnImGuiRender() {
	...
	const float orientationBoxSize = 100.0f; // TazSize of the minimap
	const float orientationBoxPadding = 10.0f;

	// TazPosition minimap in top-right corner
	...
	ImGuizmo::ViewManipulate(
		...
		orientationBoxPos,                           // TazPosition
		ImVec2(orientationBoxSize, orientationBoxSize), // TazSize
